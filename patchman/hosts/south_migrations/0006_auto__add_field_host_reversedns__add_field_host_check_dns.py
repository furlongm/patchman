...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Host.reversedns'
        db.add_column('hosts_host', 'reversedns',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Host.check_dns'
        db.add_column('hosts_host', 'check_dns',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Host.reversedns'
        db.delete_column('hosts_host', 'reversedns')

        # Deleting field 'Host.check_dns'
        db.delete_column('hosts_host', 'check_dns')
