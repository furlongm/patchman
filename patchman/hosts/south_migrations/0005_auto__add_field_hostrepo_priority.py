...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'HostRepo.priority'
        db.add_column('hosts_hostrepo', 'priority', self.gf('django.db.models.fields.IntegerField')(default=-1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'HostRepo.priority'
        db.delete_column('hosts_hostrepo', 'priority')
