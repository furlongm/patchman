...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Mirror.enabled'
        db.add_column('repos_mirror', 'enabled', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Mirror.enabled'
        db.delete_column('repos_mirror', 'enabled')
