...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Mirror.refresh'
        db.add_column('repos_mirror', 'refresh', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Mirror.refresh'
        db.delete_column('repos_mirror', 'refresh')
